...
async def cmd_help(msg: types.Message):
    ...
    txt = (
        ...
        "<b>⚙️ Адмінам</b>\n"
        "• <b>🔄 Розумна синхронізація</b> — автоматично синхронізує дані між БД та Google Sheets. Синхронізує тільки зміни, вирішує конфлікти, перевіряє витрати палива та оновлює довідники. Можлива тільки коли генератор вимкнено.\n"
